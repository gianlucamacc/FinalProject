 ...
 * @version 1.0
 */
public class BearVolley {

    // Singleton instance of the BearVolley class.
    private static BearVolley instance;
     ...
     */
    private BearVolley(Context context) {
        ctx = context;
    ...
    /**
     * Returns the singleton instance of BearVolley, creating it if necessary.
     *
     * @param context The application context used to initialize the singleton.
     * @return The singleton instance of BearVolley.
     */
    public static synchronized BearVolley getInstance(Context context) {
        if (instance == null) {
            instance = new BearVolley(context);
        }
        return instance;
    }
